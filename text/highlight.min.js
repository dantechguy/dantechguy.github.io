...
begin:"\\b("+e.join("|")+")\\b"}]};var s}})());hljs.registerLanguage("python",(()=>{"use strict";function e(e){
...
className:"meta",begin:/^[\t ]*@/,end:/(?=#)|$/,contains:[b,p,o]}]}}})());hljs.registerLanguage("json",(()=>{"use strict";return e=>({name:"JSON",
...
className:"variable.constant"},R,k,{match:/\$[(.]/}]}}})());hljs.registerLanguage("typescript",(()=>{"use strict"
...
strings:i,keywords:u}}}})());hljs.registerLanguage("rust",(()=>{"use strict";function e(...e){
...
keyword:"Self",built_in:i}},{className:"punctuation",begin:"->"},n]}}})());hljs.registerLanguage("go",(()=>{"use strict";return e=>{const n={
...
aliases:["yml"],contains:b}}})());hljs.registerLanguage("brainfuck",(()=>{"use strict";return e=>{const n={
